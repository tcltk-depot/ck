 ...
 *	left in interp's result.  If all went well then the return
 *	value is TCL_OK.
 *
 * Side effects:
 ...
 *	occurs then interp's result will contain an error message.
 *
 * Side effects:
 ...
 *	interp's result.  The return value is semi-static:  it
					 ...
					 * to check for a matching binding. */
{
     ...
     *    where interp's result is significant (for example, a widget
 ...
 *	and interp's result contains a message describing the problem.
 ...
 *
 * Results:
 *	TCL_OK or TCL_ERROR, a string is left in interp's result.
 *
 * Side effects:
 *	None.
 *
 ...
 *
 * Results:
 *	Always TCL_OK and list in interp's result.
 *
 * Side effects:
 *	None.
 *
