    ...
    char **argv;			/* Argument strings. */
{
	...
	char *strRes = "";
        ...
        switch (thing) {
	    case TOP_ARROW:     strRes = "arrow1";      break;
	    case TOP_GAP:       strRes = "trough1";     break;
	    case SLIDER:        strRes = "slider";      break;
	    case BOTTOM_GAP:    strRes = "trough2";     break;
	    case BOTTOM_ARROW:  strRes = "arrow2";      break;
        }
	Tcl_SetResult(interp, strRes, TCL_STATIC);
