 ...
 *
 * Results:
 *	If report is zero, then interp's result is filled in with
 ...
 *	edge.  If report is non-zero, then interp's result isn't modified
 ...
 *	report is non-zero, then interp's result isn't modified directly,
